...
public class DriverWithJoy extends CommandBase {
    ...
    public DriverWithJoy(DoubleSupplier leftspeed, DoubleSupplier rightspeed, Drivertrain subsystem) {
    ...
    @Override
    public void execute() {
        m_drivertrain.my_drverTank(m_leftspeed.getAsDouble(), m_rightspeed.getAsDouble());
    }

    // Called once the command ends or is interrupted.
    @Override
    public void end(boolean interrupted) {
        m_drivertrain.my_drverTank(0, 0);
    }
